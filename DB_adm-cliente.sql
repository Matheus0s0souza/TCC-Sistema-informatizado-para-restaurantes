...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 18-Jun-2024 às 15:09
...
INSERT INTO `login` (`id`, `nome`, `email`, `senha`, `cpf`, `tel`, `ende`) VALUES
(3, 'vic', 'vic@email', '123', 123, 123, 'rua');
...
(1, 'vic', 'vic@email', 'senha123', 456, 'adm', '1', 'pexels-olly-3785077.jpg'),
(7, 'marco', 'marcp@email', '123', 123, 'atendente', '3', 'pexels-italo-melo-881954-2379004.jpg'),
(13, 'jo', 'jo@email', '456', 123, 'pa', '12', 'yay.png');
...
(6, 'arroz', 1, 2, 3, 10, 50, 5, 'pexels-trista-chen-198334-723198.jpg'),
