...
<head>
    ...
    <link rel="stylesheet" href="css/registroIngrediente.css" media="screen">
...
<div>
    <section id="formulario" class="u-align-center u-clearfix u-section-1">
        <form action="controleIngredientes.php" method="get" id="ingredientes" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px">
            <div class="u-clearfix u-sheet u-sheet-1">
            <h2 class="u-text u-text-default u-text-1">Registro de ingredientes </h2>
            <div class="u-expanded-width-xs u-form u-form-1">
            <label for="ingre">Nome do ingrediente:</label>
            <input type="text" name="ingre" id="ingre" class="u-input u-input-rectangle u-text-body-color" placeholder="Insira o nome do ingrediente"><br><br>
            <label for="gramas">Gramas (g):</label>
            <input type="number" name="gramas" id="gramas" class="u-input u-input-rectangle u-text-body-color u-white" placeholder="Insira as gramas do ingrediente"><br><br>
            <label for="descricao">Descrição:</label>
            <textarea placeholder="Descrição do ingrediente" name="descricao" id="descricao" cols="30" rows="1" maxlength="190" class="u-input u-input-rectangle u-text-body-color"></textarea>
            <br><br>
